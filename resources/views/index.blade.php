...
<html lang="en">
    <head>
        ...
        <!--========== CSS ==========-->
        <link rel="stylesheet" href="{{ asset('mw/assets/css/styles.css') }}">
    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">MacWish</a>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">MacWish</h1>
                        <h2 class="home__subtitle">Try the best food of <br> the week.</h2>
                    </div>
    
                    <img src="{{ asset('mw/assets/img/macwish.png') }}" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <p class="about__description">MacWish is an SME engaged in snacks with the characteristic of macaroni mix that is crispy, savory, and rich in flavor. With variants such as MacWish Katsu, MacWish Beef Patty, MacWish Original, and MacWish Sausage, we present quality snacks that are suitable to be enjoyed anytime.We believe that snacks are not just food-but a taste experience that makes you crave for more!.</p>

                    </div>

                    <img src="{{ asset('mw/assets/img/macwish.jpg') }}" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="{{ asset('mw/assets/img/ori.jpg') }}" alt="" class="menu__img">
                        <h3 class="menu__name">MacWish Original</h3>
                        <span class="menu__detail">Mix Macaroni + Cheese Sauce + Flavour + Spicy Level</span>
                        <span class="menu__preci">Rp. 16.500</span>
                        <a href="{{ url('admin/produks/create') }}" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="{{ asset('mw/assets/img/sosis.jpg') }}" alt="" class="menu__img">
                        <h3 class="menu__name">Macwish Sausage</h3>
                        <span class="menu__detail">Mix Macaroni + Sausage + Cheese Sauce + Flavour + Spicy Level</span>
                        <span class="menu__preci">Rp 22.000</span>
                        <a href="{{ url('admin/produks/create') }}" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="{{ asset('mw/assets/img/Beff.jpg') }}" alt="" class="menu__img">
                        <h3 class="menu__name">Macwish Beef Patty</h3>
                        <span class="menu__detail">Mix Macaroni + Beef Patty + Cheese Sause + Flavour + Spicy Level</span>
                        <span class="menu__preci">Rp 24.000</span>
                        <a href="{{ url('admin/produks/create') }}" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="{{ asset('mw/assets/img/katsu.jpg') }}" alt="" class="menu__img">
                        <h3 class="menu__name">Macwish Katsu</h3>
                        <span class="menu__detail">Mix Macaroni + Chicken Katsu + Cheese Sauce + Flavour + Spicy Level</span>
                        <span class="menu__preci">Rp 26.000</span>
                        <a href="{{ url('admin/produks/create') }}" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>


                    <!-- <div class="men'u__content">
                        <img src="{{ asset('mw/assets/img/Sosis.jpg') }}" alt="" class="menu__img">
                        <h3 class="menu__name">Macwish Sausage</h3>
                        <span class="menu__detail">Mix Macaroni + Sausage + Cheese Sauce + Flavour + Spicy Level</span>
                        <span class="menu__preci">Rp 22.000</span>
                ...
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <div class="app__stores">
                            <a href="#"><img src="{{ asset('mw/assets/img/app1.png') }}" alt="" class="app__store"></a>
                            <a href="#"><img src="{{ asset('mw/assets/img/app2.png') }}" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="{{ asset('mw/assets/img/movil-app.png') }}" alt="" class="app__img">
                </div>
            </section> -->
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <p class="contact__description">We believe, that a good relationship starts with warm communication. If you have any questions, feedback, or want to order products in bulk, let's contact us..</p>
                    </div>

                    <div class="contact__button">
                        <a href="https://www.instagram.com/macwish.id?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="button">Contact us now</a>
                    </div>
                </div>
            </section>
        </main>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">MacWish</a>
                    <span class="footer__description">Fast Food</span>
                    <div>
                        <a href="https://www.instagram.com/macwish.id?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="footer__social"><i class='bx bxl-instagram'></i></a>
                    </div>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a hre  f="#" class="footer__link">Terms of services</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li>Jl. Setu Indah No.116, Tugu, Kec. Cimanggis, Kota Depok, Jawa Barat 16451</li>
                        <li>Kampus A STT NF</li>
                        <li>999 - 888 - 777</li>
                        <li>macwish@gmail.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2025 qwerty. All right reserved</p>
        </footer>
        ...
        <!--========== MAIN JS ==========-->
        <script src="{{ asset('mw/assets/js/main.js')}}"></script>
    </body>
</html>