  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form class="forms-sample" action="{{ url('admin/provinsi/update', $provinsi->id) }}" method="POST">
            @csrf
            @method('put')
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama" name="nama"
                      placeholder="Masukkan Nama" value="{{ $provinsi->nama }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="ibukota" name="ibukota"
                      placeholder="Masukkan Nama Ibukota" value="{{ $provinsi->ibukota }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="lattitude" name="lattitude"
                      placeholder="Masukkan Lattitude" value="{{ $provinsi->lattitude }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="longitude" name="longitude"
                      placeholder="Masukkan Longitude" value="{{ $provinsi->longitude }}">
              </div>
          </div>
          <div class="form-group row">
