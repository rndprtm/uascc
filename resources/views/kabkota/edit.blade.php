...
<head>
  ...
  <title>Form Kabupaten Kota</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form class="forms-sample" action="{{ url('admin/kabkota/update', $kabkota->id) }}" method="POST">
            @csrf
            @method('put')
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama" name="nama"
                      placeholder="Masukkan Nama" value="{{ $kabkota->nama }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="lattitude" name="lattitude"
                      placeholder="Masukkan Longitude" value="{{ $kabkota->lattitude }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="longitude" name="longitude"
                      placeholder="Masukkan Longitude" value="{{ $kabkota->longitude }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="provinsi_id" name="provinsi_id"
                      placeholder="Masukkan Provinsi ID" value="{{ $kabkota->provinsi_id }}">
              </div>
          </div>
          <div class="form-group row">
