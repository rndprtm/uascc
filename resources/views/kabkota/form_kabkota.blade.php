  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form class="forms-sample" action="{{ url('admin/kabkota/store') }}" method="POST">
            @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="provinsi_id" name="provinsi_id" placeholder="Masukkan Provinsi ID">
              </div>
          </div>
          <div class="form-group row">
